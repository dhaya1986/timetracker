...
var TimeTrackingProjects = require('../models/timeTrackingProjects');
const { convertJSONTOXL } = require('./generateExcel')

const AdminApprovedProject = async (year) => {
  ...
  await Promise.all(projects.map (async (project) => {
      ...
      //console.log(TimeTrackingProjects);
      timeTrack.map((tt) => {
...
module.exports = AdminApprovedProject;
//adminApprove : true,
